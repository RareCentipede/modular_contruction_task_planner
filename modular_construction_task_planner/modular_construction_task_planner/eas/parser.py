...
def parse_block_list_to_world(block_list: List[Block], robot_init_pose: PoseStamped) -> World:
    ...
    define_base_and_place_poses(block_list, pose_dict, entities)
...
def define_base_and_place_poses(block_list: List[Block], pose_dict: Dict[str, Pose], entities: Entities):
    for block in block_list:
